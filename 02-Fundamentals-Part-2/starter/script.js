...
const checkWinner = function(scoreDolphins, scoreKoalas) {
    ...
    else if (scoreKoalas >= scoreDolphins * 2) console.log(`Koalas win (${scoreKoalas} vs. ${scoreDolphins})`);
...
else console.log(`${john.fullName}'s BMI (${john.bmi}) is higher than ${mark.fullName}'s (${queueMicrotask.bmi})!`);
